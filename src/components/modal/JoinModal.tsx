                ...
                {isDailyModal && (
                    <>
                        ...
                        <p className="text-center text-white">
                            Think you can guess the word of the day? You’ve got
                            6 tries to crack the code. Earn up to{" "}
                            <span className="text-[#FE97D5]">25 points </span>
                            if you get it right on the first try and move closer
                        ...
                        <p className="text-center">
                            Makes sense to always start out with an "AEIOU"
                            combination so you know all vowels
                        </p>
                    </>
                )}
                {!isDailyModal && (
