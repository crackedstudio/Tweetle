  ...
  return (
    <>
      <div className="bg-[#000000] h-[80%] w-full absolute top-[10%]">
        <button className="relative top-4 left-[90%]" onClick={cancelHandler}>
        ...
        <>
            ...
            {isDailyModal && (
              <>
                ...
                <p className="text-center text-white">
                  ...
                  if you get it right on the first try and move closer to the
                ...
                <p className="text-center">
                  Makes sense to always start out with an "AEIOU" combination so
                  you know all vowels
                </p>
              </>
            )}
                ...
                <DashboardButtons where="/">
                  <div className="flex flex-col space-y-3">
                    ...
                    <p className="text-center text-xs">
                      KIndly ensure you have deployed your starknet account
                      before proceeding
                    </p>
                  </div>
                </DashboardButtons>
          ...
          <div className="mt-2 px-3 flex flex-col space-y-6 items-center">
            <button
              className="bg-[#12830D] text-center w-[203px] block py-4 text-sm rounded-xl text-white border-[3px] border-[#71ED00] shadow-[0_5px_0_0_rgba(0,81,37,1),0_7px_0_0_rgba(113,237,0,1)]"
              onClick={joinHandler}
            >
